            ...
            <ol className="inline-flex items-center space-x-1 md:space-x-3">
              ...
              <li aria-current="page">
                <div className="flex items-center">
                  ...
                  <span className="ml-1 text-gray-500 md:ml-2">{service.name}</span>
                </div>
              </li>
            </ol>
          </nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <div className="h-96 bg-gray-200 flex items-center justify-center">
                <span className="text-gray-500 text-2xl font-semibold">{service.name}</span>
              </div>
            </div>
          ...
          <div className="mt-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">We understand your requirements and goals</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">We deliver high-quality results on time</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
          ...
          <div className="mt-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {services
                ...
                .map((relatedService) => (
                  <div key={relatedService.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                    <div className="h-48 bg-gray-200 flex items-center justify-center">
                      <span className="text-gray-500 text-lg">{relatedService.name}</span>
                    </div>
                    <div className="p-6">
                      <h3 className="text-xl font-semibold text-gray-900 mb-2">{relatedService.name}</h3>
                      <p className="text-gray-600 mb-4 line-clamp-3">{relatedService.description}</p>
                      <div className="flex justify-between items-center">
                        <span className="text-green-600 font-semibold">{relatedService.price}</span>
                        <Link
