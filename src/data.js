...
export const individualProduct = [
  {
    ...
    description: "Get your personalized program and start your journey to a healthier, happier you.",
    ...
    howItWorks: {
      ...
      description: "From a simple photo of your plate, the NutriGen app is able to recognize the food items, estimate the quantity, and provide nutritional information within seconds.",
      steps: [
        {
          title: "Select a meal",
          image: "1.png"
    ...
    useCases: [
      {
        ...
        description: "Ideal for fitness tracking, weight management, and health-conscious eating."
      },
      {
        title: "🏢 For Companies", 
        description: "Perfect for employee wellness programs and smart cafeterias."
      },
      {
        title: "💻 For Developers",
        description: "Use our API to build nutrition-based tools and apps easily."
      }
    ],
    ...
    faqs: [
      {
        ...
        answer: "NutriGen is a smart food scanning app that helps track nutrition by scanning QR codes."
      },
      {
        question: "Is NutriGen free?",
        answer: "Yes, NutriGen is free to use for individual users. API integrations may have usage limits."
      },
      {
        question: "What data sources does it use?",
        answer: "It uses OpenFoodFacts and AI-powered recognition to fetch and analyze food data."
      }
    ],
    ...
    cta: {
      ...
      subtitle: "Start using NutriGen or contact us for integration into your platform.",
