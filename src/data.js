...
// export const products = [
//   { label: 'NutriGen', path: '/product/nutrigen', icon: nutrigenLogo },
//   { label: 'DataGPT', path: '/product/datagpt', icon: datagptLogo },
//   { label: 'Resume Analyzer', path: '/product/resume-analyzer', icon: resumeLogo },
// ];

// export const services = [
//   { label: 'Industrial Training', path: '/service/industrial-training' },
//   { label: 'App Development', path: '/service/app-development' },
//   { label: 'Web Development', path: '/service/web-development' },
//   { label: 'AI Processed Solution', path: '/service/ai-processed-solution' },
//   { label: 'Explore More...', path: '/services' },
// ];
